...
def draw_object2(izvor):
    ...
    for i in polygon_list:
        ...
        ni1 = izvor_normal(d1, izvor)
        ni2 = izvor_normal(d2, izvor)
        ni3 = izvor_normal(d3, izvor)
        ...
        pyglet.gl.glColor3f(ia * ka + ii * kd * angle1, 0,
                            0)
        pyglet.gl.glVertex2f(d1[0], d1[1])
        pyglet.gl.glColor3f(ia * ka + ii * kd * angle2, 0,
                            0)
        pyglet.gl.glVertex2f(d2[0], d2[1])
        pyglet.gl.glColor3f(ia * ka + ii * kd * angle3, 0,
                            0)
        pyglet.gl.glVertex2f(d3[0], d3[1])
