...
def draw_object2(izvor):
    ...
    for i in polygon_list:
        ...
        batch.add(3, pyglet.gl.GL_TRIANGLES, None,
                            ('v2i', (dots[i[0] - 1][0], dots[i[0] - 1][1], dots[i[1] - 1][0], dots[i[1] - 1][1], dots[i[2] - 1][0], dots[i[2] - 1][1])),
                            ('c3f', (ia * ka + ii * kd * angle(izvor, n1), 75, 194)))


        # pyglet.graphics.glBegin(pyglet.gl.GL_TRIANGLES)
        # pyglet.gl.glColor3f(ia * ka + ii * kd * angle(izvor, n1), 75, 194)
